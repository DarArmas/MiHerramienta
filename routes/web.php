...
Route::get('catalogo/fetchCatalogo', [CatalogoController::class, 'fetchCatalogo'])->name('catalogo.fetchCatalogo');
...
Route::get('inventario/fetchInventario', [InventarioController::class, 'fetchInventario'])->name('inventario.fetchInventario');
